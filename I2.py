...
class I2:
    ...
    def __init__(self, src: BufferedReader | Iterator[Sequence[str]]):
        ...
        The iterator should return a list of strings for every (logical) row of CSV.
        The fields should be in the Crowdin format:
            "Key","Type","Desc","{lang[0].name} {lang[0].code}","{lang[1].name} {lang[1].code}",...\\n
            "{id}","Text","","{item[0]}","{item[1]}",...\\n
            ...
        Quotechars in values should be doubled.
        """
        if isinstance(src, BufferedReader):
    ...
    def __str__(self):
        ...
        See cls.__init__() docstring for the format.
        """
